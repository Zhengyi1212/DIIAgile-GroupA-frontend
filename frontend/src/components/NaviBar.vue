...
.profile-section {
  position: relative;
  margin-left: auto; /* Align profile section to the right */
  margin-right: 2.5rem; /* Add some space from the right edge */
}
...
.dropdown-menu {
  position: absolute;
  top: 60px; /* Adjusted to position under the avatar */
  left: 40%; /* Center the dropdown menu horizontally */
  ...
  z-index: 1000;
  width: 180px; /* Enlarge the dropdown menu */
}
...
.personal-info {
  ...
  cursor: pointer;
  font-size: 14px;
  background-color: rgb(111, 161, 227); /* Blue color */
  color: white;
}

.personal-info:hover {
  background-color: #1c6adf; /* Darker blue on hover */
}
...
.exit-button:hover {
  background-color: #5c2425; /* Darker red on hover */
}
</style>